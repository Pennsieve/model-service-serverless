...
resource "aws_cloudwatch_log_group" "model_service_lambda_loggroup" {
...
resource "aws_cloudwatch_log_subscription_filter" "cloudwatch_log_group_subscription" {
  name            = "${aws_cloudwatch_log_group.model_service_lambda_loggroup.name}-subscription"
  log_group_name  = aws_cloudwatch_log_group.model_service_lambda_loggroup.name
  filter_pattern  = ""
